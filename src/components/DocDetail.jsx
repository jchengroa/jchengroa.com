...
export default function DocDetail() {
    ...
    return (
      <section className="min-h-screen pt-32 pb-20 px-6 flex flex-col items-center bg-gray-50/50 dark:bg-gray-950">
        <div className="text-center py-20">
          ...
          <Link to="/docs" className="inline-flex items-center gap-2 px-6 py-3 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-2xl font-black text-sm hover:scale-105 transition-all">
  ...
  return (
    <section className="relative min-h-screen pt-32 pb-20 px-6 flex flex-col items-center overflow-hidden bg-gray-50/50 dark:bg-gray-950">
      ...
      <div className="max-w-4xl w-full z-10">
        ...
        >
          ...
          {/* Header */}
          <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] p-10 border border-gray-100 dark:border-gray-800 shadow-sm mb-12">
              ...
              <div>
                ...
                {doc.tech && doc.tech.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-6">
                    {doc.tech.map((t, idx) => (
                      <span key={idx} className="px-3 py-1 bg-gray-50 dark:bg-gray-800/50 border border-gray-100 dark:border-gray-700 rounded-lg text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-wider">{t}</span>
                    ))}
                  </div>
                )}
              </div>
          ...
          <div className="space-y-12">
            {content.intro && content.intro !== "Temporary" && (
              <div className="bg-white dark:bg-gray-900 rounded-[2rem] p-10 border border-gray-100 dark:border-gray-800 shadow-sm">
                <p className="text-lg text-gray-600 dark:text-gray-300 font-medium leading-relaxed">{content.intro}</p>
              </div>
            )}
            ...
            {content.sections.map((section, idx) => (
              <motion.div
                ...
                className="bg-white dark:bg-gray-900 rounded-[2rem] p-10 border border-gray-100 dark:border-gray-800 shadow-sm scroll-mt-36"
              >
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                  <p className="text-gray-600 dark:text-gray-300 font-medium leading-relaxed text-lg">{section.text}</p>
                </div>
                ...
                {doc.outline?.[idx]?.sub && doc.outline[idx].sub.length > 0 && (
                  <div className="mt-10 space-y-6">
                    {doc.outline[idx].sub.map((sub, si) => {
                      ...
                      return (
                        <div key={si} id={subId} className="border-l-2 border-gray-200 dark:border-gray-800 pl-5 scroll-mt-36">
                          <h3 className="text-base font-black text-gray-900 dark:text-white mb-2">{sub}</h3>
                          <p className="text-gray-500 dark:text-gray-400 text-sm leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                      );
                    })}
                  </div>
