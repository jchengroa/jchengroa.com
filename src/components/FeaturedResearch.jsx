...
function FeaturedResearch() {
    ...
    return (
        <section className="py-24 bg-gray-50/50 overflow-hidden relative group/section">
            <div className="mb-16 text-center">
                <Title title="Featured Research" />
                <p className="text-gray-500 max-w-2xl mx-auto -mt-4 font-medium text-lg px-4">
                    A look into my academic work and studies.
                </p>
            </div>
            ...
            >
                ...
                <div className="absolute inset-y-0 left-0 w-16 md:w-48 bg-gradient-to-r from-gray-50/50 via-gray-50/20 to-transparent z-10 pointer-events-none"></div>
                <div className="absolute inset-y-0 right-0 w-16 md:w-48 bg-gradient-to-l from-gray-50/50 via-gray-50/20 to-transparent z-10 pointer-events-none"></div>
                ...
                >
                    {researchList.map((research) => (
                        <div key={research.id} className="w-[300px] md:w-[500px] flex-shrink-0 snap-center">
                            <WorkCard
                                id={research.id}
