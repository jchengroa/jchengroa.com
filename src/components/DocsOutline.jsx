      ...
      <AnimatePresence>
        {isDesktopOpen ? (
          <motion.div
            ...
            className="hidden xl:flex fixed left-6 top-28 bottom-6 z-40 w-72 bg-white/70 dark:bg-gray-900/70 backdrop-blur-2xl border border-gray-200/50 dark:border-gray-800/50 rounded-[2.5rem] p-5 shadow-2xl flex-col justify-between overflow-hidden"
          >
            <div>
              <div className="flex items-center justify-between mb-5 px-1">
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-black tracking-widest uppercase text-gray-900 dark:text-white">Documentation</span>
                </div>
                <button
          ...
          <motion.button
            ...
            title="Show Documentation Outline"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z"/><path d="M6 5h10"/><path d="M6 9h10"/><path d="M6 13h6"/></svg>
          </motion.button>
        )}
      </AnimatePresence>
