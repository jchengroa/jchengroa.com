        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 sm:gap-6">
                ...
                <div className="lg:col-span-5 p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-gray-900 border border-gray-200/80 dark:border-gray-800 shadow-sm space-y-5">
                    {(() => {
                        const loadedItem = research.find(r => r.id === currentItem.id);
                        ...
                        <div>
                            ...
                            <div className="space-y-1.5 mb-2">
                                {(currentItem.stats || []).map((st, idx) => (
                                    <div key={idx} className="flex items-center justify-between p-2 rounded-xl bg-gray-50 dark:bg-gray-800 text-xs">
                                        ...
                                        <button type="button" onClick={() => handleRemoveStat(idx)} className="text-rose-500 font-bold p-0.5">✕</button>
                                    </div>
                                ))}
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                <input
                                    ...
                                    className="px-3 py-2 sm:py-1.5 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm sm:text-xs font-semibold text-gray-900 dark:text-white"
                                />
                                <input
                                    type="text"
                                    ...
                                    className="px-3 py-2 sm:py-1.5 rounded-xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm sm:text-xs font-mono font-bold text-gray-900 dark:text-white"
                                />
                            </div>
                            <button
                                type="button"
                                onClick={handleAddStat}
                                className="mt-2 w-full py-2 sm:py-1.5 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-xs font-bold rounded-xl cursor-pointer"
                            >
                                + Add Metric
                            </button>
                        </div>
